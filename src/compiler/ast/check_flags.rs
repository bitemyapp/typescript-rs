...
bitflags! {
    /// Flags used by the type checker for tracking special properties of symbols
    #[derive(Debug)]
    pub struct CheckFlags: u32 {
        ...
        /// Calculation of the type of this symbol is deferred due to processing costs, should be fetched with `get_type_of_symbol_with_deferred_type`
